...
public class GetQuery_Tests : PostgreSqlDbClient_Setup
{
	[Fact]
	...
	public void With_Parts_Sets_Parameters()
	{
		...
		var c0Name = Rnd.Str;
		var c0Value = Rnd.Str;
		IColumn c0 = new Column(c0Table, c0Name, Helpers.CreateInfoFromAlias());

		var c1Table = new TableName(Rnd.Str);
		var c1Name = Rnd.Str;
		var c1Value = Rnd.Int;
		IColumn c1 = new Column(c1Table, c1Name, Helpers.CreateInfoFromAlias());
