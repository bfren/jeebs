...
namespace Jeebs.WordPress.TypeHandlers
{
	...
	public sealed class MimeTypeHandler : Dapper.SqlMapper.TypeHandler<MimeType>
	{
		...
		public override MimeType Parse(object value) => MimeType.Parse(value.ToString());
		...
		public override void SetValue(IDbDataParameter parameter, MimeType value) => parameter.Value = value.ToString();
	}
}
