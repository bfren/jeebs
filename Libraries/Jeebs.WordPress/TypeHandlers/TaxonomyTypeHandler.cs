...
namespace Jeebs.WordPress.TypeHandlers
{
	...
	public sealed class TaxonomyTypeHandler : Dapper.SqlMapper.TypeHandler<Taxonomy>
	{
		...
		public override Taxonomy Parse(object value) => Taxonomy.Parse(value.ToString());
		...
		public override void SetValue(IDbDataParameter parameter, Taxonomy value) => parameter.Value = value.ToString();
	}
}
