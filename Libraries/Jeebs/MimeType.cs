...
namespace Jeebs
{
	...
	public class MimeType : Enumerated
	{
		...
		public static MimeType Doc =>
			new MimeType("application/msword");
		...
		public static MimeType Ppt =>
			new MimeType("application/vnd.ms-powerpoint");
		...
		public static MimeType Tar =>
			new MimeType("application/x-tar");
		...
		public static MimeType Xls =>
			new MimeType("application/vnd.ms-excel");
