...
namespace Jeebs
{
	public static partial class RExtensions
	{
		...
		/// <param name="t">The task will be executed if the current object is an <see cref="IOk{T}"/> result</param>
		...
		/// <typeparam name="TResult">Result value type</typeparam>
		/// <param name="this">Current result task (will be awaited before executing <paramref name="t"/>)</param>
		/// <param name="t">The task will be executed if the current object is an <see cref="IOkV{T}"/> result</param>
		...
		/// <param name="t">The task will be executed if the current object is an <see cref="IOk{T}"/> result</param>
		public static Task<IR<TResult>> LinkMapAsync<TSource, TResult>(this IR<TSource> @this, Func<Task<TResult>> t) => LinkMapAsync(Task.Run(() => @this), t);
		...
		/// <param name="this">Current result>/param>
		/// <param name="t">The task will be executed if the current object is an <see cref="IOk{T}"/> result</param>
		public static Task<IR<TResult>> LinkMapAsync<TSource, TResult>(this IR<TSource> @this, Func<IOk<TSource>, Task<IR<TResult>>> t) => LinkMapAsync(Task.Run(() => @this), t);
		...
		/// <param name="this">Current result>/param>
		/// <param name="t">The task will be executed if the current object is an <see cref="IOkV{T}"/> result</param>
		public static Task<IR<TResult>> LinkMapAsync<TSource, TResult>(this IR<TSource> @this, Func<IOkV<TSource>, Task<IR<TResult>>> t) => LinkMapAsync(Task.Run(() => @this), t);
