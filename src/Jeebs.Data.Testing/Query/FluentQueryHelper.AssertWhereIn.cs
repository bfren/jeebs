...
public static partial class FluentQueryHelper
{
	...
	/// <summary>
	/// Validate a call to <see cref="IFluentQuery{TEntity, TId}.WhereIn"/>
	/// </summary>
	...
	{
		// Check the method
		AssertMethodName(call, nameof(IFake.WhereIn));
