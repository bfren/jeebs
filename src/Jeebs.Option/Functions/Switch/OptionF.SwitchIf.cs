...
namespace F
{
	...
	{
		/// <summary>
		/// If the input <paramref name="option"/> is <see cref="Some{T}"/>, runs <paramref name="check"/> function -<br/>
		...
		/// <summary>
		/// If the input <paramref name="option"/> is <see cref="Some{T}"/>, runs <paramref name="check"/> function -<br/>
		/// if it returns false, returns <see cref="Jeebs.None{T}"/> with the Reason from <paramref name="ifFalse"/>,<br/>
		/// otherwise, the original <paramref name="option"/> is returned.
		/// </summary>
		/// <typeparam name="T">Option value type</typeparam>
		/// <param name="option">Option being switched</param>
