...
public static partial class MaybeF
{
	...
	/// <summary>
	/// Create a <see cref="Jeebs.Internals.Some{T}"/> Maybe, containing <paramref name="value"/><br/>
	...
	/// <summary>
	/// Create a <see cref="Jeebs.Internals.Some{T}"/> Maybe, containing <paramref name="value"/>
	/// </summary>
	/// <typeparam name="T">Maybe value type</typeparam>
	/// <param name="value">Some value</param>
