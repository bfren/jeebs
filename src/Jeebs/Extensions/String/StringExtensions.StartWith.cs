...
public static partial class StringExtensions
{
	...
	public static string StartWith(this string @this, char character) =>
		Modify(@this, () => string.Format(F.DefaultCulture, "{0}{1}", character, @this.TrimStart(character)));
	...
	public static string StartWith(this string @this, string value) =>
		Modify(@this, () => string.Format(F.DefaultCulture, "{0}{1}", value, @this.TrimStart(value)));
}
