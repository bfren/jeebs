...
public static partial class AuthF
{
	...
	public static async Task<AuthOp> CreateCookieAsync(HttpContext http, ClaimsPrincipal user, bool persist, string? redirectUrl)
	{
		...
		return new AuthOp.SignedIn(redirectUrl);
	}
}
